  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
      <div className="bg-white w-[1150px] p-6 sm:p-8 md:w-[80%] lg:w-[60%] xl:w-[60%] rounded-lg shadow-2xl">
        <h2 className="text-2xl font-bold mb-6 text-center">Report Comment</h2>
        ...
        {selectedReason === 'Something else' && (
          <textarea
            className="w-full h-32 p-3 mt-6 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-lg"
